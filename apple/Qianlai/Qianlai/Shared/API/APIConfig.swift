...
extension APIConfig {
    /// App identity + defaults for Qianlai. Modules should use
    /// `APIClient.shared` instead of re-declaring any of these.
    nonisolated static let appCode = "qianlai"
    nonisolated static let defaultBaseURL = URL(string: "https://platform.hapaul.top")!
    nonisolated static let keychainService = "top.hapaul.qianlai.auth"
