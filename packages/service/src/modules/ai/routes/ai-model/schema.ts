...
export const aiModelSchema = z
  .object({
    ...
    imageMediaTypes: z.string().array(),
...
export const createAiModelBodySchema = z.object({
  ...
  maxImageEdge: z.number().int().nullable().optional(),
  maxPixelsPerImage: z.number().int().nullable().optional(),
  maxImagesPerRequest: z.number().int().nullable().optional(),
  imageMediaTypes: z.string().array().optional(),
