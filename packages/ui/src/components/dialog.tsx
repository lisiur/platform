...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return (
    <div
      ...
      className={cn(
        !isScreenReaderOnly &&
          "flex shrink-0 flex-col gap-2 bg-popover p-4 pr-12",
        className,
      )}
      {...props}
    />
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "mt-auto flex shrink-0 flex-col-reverse gap-2 rounded-b-xl border-t bg-muted/50 p-4 sm:flex-row sm:justify-end",
        className,
      )}
      {...props}
    >
